Shader "Exemple 2/CustomGI_ToneMapped" 
{
        Properties 
        {
            _MainTex ("Albedo (RGB)", 2D) = "white" {}
            _Gain("Lightmap tone-mapping Gain", Range(0,1)) = 1
            _Knee("Lightmap tone-mapping Knee", Range(0,1)) = 0.5
            _Compress("Lightmap tone-mapping Compress", Range(0,1)) = 0.33
        }
